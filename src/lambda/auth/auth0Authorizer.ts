...
const jwksUrl = 'https://dev-beba1xrualyix42q.us.auth0.com/.well-known/jwks.json'
...
export const handler = async (
  ...
  try {
    ...
    logger.info('Authorized token: ', jwtToken)
    ...
    logger.error('Authorized error: ', { error: e.message })
